...
post-merge CI and Pages successful. Main is
...
localhost. Safety gates pass; không mở Camunda effectful hoặc real cohort.

## M5-CAM-002-UI-ONLY-LOCAL — DONE / LOCAL HOLD (2026-08-10)

Đã thêm panel localhost và read-only API route cho aggregate-only M5 shadow
report. UI chỉ hiển thị manual-review/safety counters; raw values, Camunda,
HRIS/notification và real cohort vẫn bị khóa.
...
không sửa parser, không rerun DATA-24 và không promote fallback. Held-out
generalization tiếp tục `HOLD`.
...
| OCR-HO-V2-018G | DONE / HOLD | Reviewed 018F for selector opening; recognizer dominance passes but prior DER worsens `+0.007905`, diacritic errors `+2`, strict exact `-1`, and 017E/017F have zero switches; counterfactual denied | OCR-HO-V2-018F | P0 |
| OCR-HO-V2-018H | DONE / HOLD | Safety-evidence review finds non-regression, eligible-switch and replay-change evidence missing; explicit authorization absent; counterfactual/runtime/replay/promotion remain closed | OCR-HO-V2-018G | P0 |
| OCR-HO-V2-018I | DONE / HOLD | Intake accepted private authorization matching 018H digest/scope for safety review only; selector change/counterfactual/replay/held-out/evaluate-once/runtime/promotion remain false | OCR-HO-V2-018H | P0 |
| OCR-HO-V2-018J | DONE / HOLD | Aggregate safety evidence collected from sealed 018I/018H/018G; DER non-regression FAIL, zero eligible switches and zero replay changes; selector/counterfactual/replay/runtime/promotion remain closed | OCR-HO-V2-018I | P0 |
| OCR-HO-V2-018K | DONE / HOLD | Reviewed 018J aggregate evidence; selector counterfactual is not recommended because DER non-regression failed and no switch/replay field changed; explicit new owner authorization remains required | OCR-HO-V2-018J | P0 |
| OCR-HO-V2-018L | DONE / HOLD | Accepted private owner authorization matching 018K digest and 15/120/45 scope for future diagnostic counterfactual review only; execution, selector change, replay and runtime remain false | OCR-HO-V2-018K | P0 |
| OCR-HO-V2-018M | DONE / HOLD | Authorized sealed-aggregate selector simulation completed; DER worsened `+0.007905`, diacritic errors `+2`, strict exact `-1`; no OCR rerun, selector change, replay, runtime or promotion | OCR-HO-V2-018L | P0 |
| OCR-HO-V2-018N | DONE / HOLD | Closed selector path after 018M regression: DER `+0.007905`, diacritic `+2`, strict exact `-1`; no selector/replay/runtime/held-out/promotion | OCR-HO-V2-018M | P0 |
| OCR-HO-V2-018O | DONE / HOLD | Selected `RECOGNIZER_TOKEN_ALIGNMENT` as the single next layer: recognizer disagreement `291/375 = 77.6%`; detector/crop dominant boundary category `8/18 = 44.44%`, below patch threshold | OCR-HO-V2-018N | P0 |
| OCR-HO-V2-018P | DONE / HOLD | Aggregate-only recognizer/token attribution: AUTO_REGION_HIT disagreement `291/375 = 77.6%`; residence `116`, origin `96`, fullName `79`; no selector/replay/runtime/promotion | OCR-HO-V2-018O | P0 |
| OCR-HO-V2-018Q | DONE / HOLD | Selected bounded sub-layer `PLACE_OF_RESIDENCE_RECOGNIZER_DISAGREEMENT`: residence `116` vs line-order `32` and token mismatch `11`; no selector/profile/variant/replay/runtime change | OCR-HO-V2-018P | P0 |
| OCR-HO-V2-018R | DONE / HOLD | Reviewed residence cohort against global profile/variant aggregates; cross-tab is unavailable, so no profile/variant winner or selector path is opened | OCR-HO-V2-018Q | P0 |
| OCR-HO-V2-018S | DONE / HOLD | Validated 16 residence-specific profile×variant oracle rows; max ASCII exact `2/15` vs gate `13/15`; no profile/variant winner or selector opening | OCR-HO-V2-018R | P0 |
| OCR-HO-V2-018T | DONE / HOLD | Cross-tab ceiling remains `2/15` vs gate `13/15`; selected one bounded residence recognizer error-class attribution diagnostic, with selector/replay/runtime closed | OCR-HO-V2-018S | P0 |
| OCR-HO-V2-018U | DONE / HOLD | Confirmed residence recognizer disagreement `116/160 = 72.5%`; existing evidence lacks a residence profile/variant-by-error-class joint cross-tab, so no selector or runtime change | OCR-HO-V2-018T | P0 |
| OCR-HO-V2-018V | DONE / HOLD | Authorized aggregate-only review confirmed residence profile/variant metrics and field error classes are not a joint cross-tab; no winner, selector, OCR, counterfactual, replay, runtime change or promotion | OCR-HO-V2-018U | P0 |
| OCR-HO-V2-018W | DONE / HOLD | Authorized sealed extractor produced 16 residence profile×variant rows, 15 documents each, with aggregate error classes only; no winner, selector, OCR, counterfactual, replay, runtime change or promotion | OCR-HO-V2-018V | P0 |
| OCR-HO-V2-018X | DONE / HOLD | Reviewed the complete sealed 16×15 joint table: 240 aggregate groups, 15 recognizer-dominant rows and one line-ID-miss-dominant row; no winner, selector, counterfactual, replay, runtime change or promotion | OCR-HO-V2-018W | P0 |
| OCR-HO-V2-018Y | DONE / HOLD | Reviewed 240 aggregate groups: recognizer disagreement `116`, line-ID miss `81`; no class reached 50%, so selected one bounded `RESIDENCE_LINE_ID_MISS_BOUNDARY_ATTRIBUTION` diagnostic; no selector, counterfactual, replay, runtime or promotion | OCR-HO-V2-018X | P0 |
| OCR-HO-V2-018Z | DONE / HOLD | Authorized aggregate-only residence boundary attribution: bottom boundary `3/5 = 60%`, global boundary `8/18 = 44.44%`; profile/variant boundary cross-tab unavailable; no patch, selector, replay, runtime or promotion | OCR-HO-V2-018Y | P0 |
| OCR-HO-V2-019A | DONE / HOLD | Reviewed 018Z against shadow patch/replay evidence: global boundary `8/18`, cross-tab unavailable, quality unproven, 018C DER gate HOLD; patch review not warranted and no runtime change | OCR-HO-V2-018Z | P0 |
| OCR-HO-V2-019B | DONE / HOLD | Independently extracted 48 aggregate cross-tab rows across 16 profile/variant combinations; 80/81 line-ID misses map to five boundary documents; no patch, selector, replay, runtime or promotion | OCR-HO-V2-019A | P0 |
| OCR-HO-V2-019C | DONE / HOLD | Reviewed 48 independent cross-tab rows: one identical boundary signature across all 16 profile/variant combinations; no winner, patch, selector, replay, runtime or promotion | OCR-HO-V2-019B | P0 |
| OCR-HO-V2-019D | DONE / HOLD | Independently measured per-profile/variant quality across 4 profiles, 4 variants and 16 combinations; residence oracle ASCII peaks at `2/15`, zero combinations qualify; no patch, selector, replay, runtime or promotion | OCR-HO-V2-019C | P0 |
| OCR-HO-V2-019E | DONE / HOLD | Reviewed 48 independent quality rows: zero full non-regression passes, residence oracle max `2/15`, and zero gate-qualified combinations; no selector, patch, replay, runtime or promotion | OCR-HO-V2-019D | P0 |
| OCR-HO-V2-019F | DONE / HOLD | Closed the profile/variant selection path and recorded five reopen requirements for a new independent evidence package; no selector, patch, replay, runtime or promotion | OCR-HO-V2-019E | P0 |
| OCR-HO-V2-019G | DONE / HOLD | Reviewed independent prediction/GroundTruth package intake; no complete package was available, no GroundTruth was created/opened, and selector/runtime/replay paths remain closed | OCR-HO-V2-019F | P0 |
| OCR-HO-V2-019H | DONE / HOLD | Reviewed independent prediction/GroundTruth lock requirements; no package manifest was available, so no GroundTruth/replay/evaluate-once action occurred and all runtime paths remain closed | OCR-HO-V2-019G | P0 |
| OCR-HO-V2-019I | DONE / HOLD | Confirmed 019H package lock is unavailable and explicitly closed development replay/evaluate-once; no GroundTruth, selector, runtime or promotion action occurred | OCR-HO-V2-019H | P0 |
| OCR-HO-V2-019J | DONE / HOLD | Rechecked private inventory for a new independent package/lock; none was found, so replay/evaluate-once/selector/runtime/promotion remain closed | OCR-HO-V2-019I | P0 |
| OCR-HO-V2-019K | DONE / HOLD | Confirmed 019J has no independent package/lock and kept replay/evaluate-once/selector/runtime/promotion closed; no GroundTruth action occurred | OCR-HO-V2-019J | P0 |
| OCR-HO-V2-019L | DONE / HOLD | Reconfirmed no independent package/lock and kept replay/evaluate-once/selector/runtime/promotion closed; no GroundTruth action occurred | OCR-HO-V2-019K | P0 |
| OCR-HO-V2-019M | READY | Wait for a complete independent package/lock before any replay review; keep all execution paths closed | OCR-HO-V2-019L | P0 |
