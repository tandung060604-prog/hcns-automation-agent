...
**Trạng thái:** hoàn thành demo bốn nhánh nghiệp vụ. Báo cáo này chỉ ghi nhận kết quả tổng hợp và
hành vi workflow; tài liệu gốc, ảnh chụp, nội dung OCR, JSON trích xuất và mã tham chiếu được giữ
ở vùng private local, không đưa vào Git.
...
## 3. Kết quả theo kịch bản

### 3.1. Leave Request — kiểm tra hai cấp
...
### 3.2. Overtime Request — nhánh xác nhận nhanh
...
### 3.3. Overtime Request — yêu cầu tải lại
...
### 3.4. Leave Request — từ chối có kiểm soát
...
## 4. Bằng chứng vận hành đã quan sát
...
## 5. Liên hệ với chất lượng trích xuất
...
## 7. Đề xuất phát triển tiếp theo
