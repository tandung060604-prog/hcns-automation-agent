...
Hai template đang được hỗ trợ:

| Template | Document type | Định dạng | Cách đọc |
|---|---|---|---|
| `leave-request-v1` | `LEAVE_REQUEST` | DOCX | Native OOXML |
| `overtime-request-v1` | `OVERTIME_REQUEST` | DOCX | Native OOXML |
